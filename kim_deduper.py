...
def get_args():
    parser = argparse.ArgumentParser(description="Remove PCR duplicates in a sorted sam file of uniquely mapped reads.")
    ...
    parser.add_argument("-u", "--umi", help="Valid UMIs.", required=True, type = str)
...
# re-set the tuple set and chrom var for each new chromosome:
        ...
        else: # identifierTup IS ALREADY IN unique records set, it's a duplicate
            dupes += 1
